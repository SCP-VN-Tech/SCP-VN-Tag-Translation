...
// TOML parser
window.tomlParse = function tomlParse(input) {
	var nodes = _tomlParse(input.toString());
	return _tomlCompile(nodes);
}
...
/*
   ...
   * http://pegjs.majda.cz/
*/
window.peg$subclass = function peg$subclass(child, parent) {
	function ctor() { this.constructor = child; }
	ctor.prototype = parent.prototype;
	child.prototype = new ctor();
}

window.TomlSyntaxError = function TomlSyntaxError(message, expected, found, offset, line, column) {
...
peg$subclass(TomlSyntaxError, Error);

window._tomlParse = function _tomlParse(input) {
...
window._tomlCompile = function _tomlCompile(nodes) {
	var assignedPaths = [];
